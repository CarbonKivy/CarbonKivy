...
register("CBadge", module="carbonkivy.uix.badge")
...
register("CLabelNeutral", module="carbonkivy.uix.label")
register("CLabelNeutralCircular", module="carbonkivy.uix.label")
...
register("CRadioButton", module="carbonkivy.uix.radio")
register("CRadioButtonLabel", module="carbonkivy.uix.radio")
register("CRadioGroup", module="carbonkivy.uix.radio")
register("CRadioGroupHelperText", module="carbonkivy.uix.radio")
register("CRadioGroupLabel", module="carbonkivy.uix.radio")
register("CRadioGroupLayout", module="carbonkivy.uix.radio")
register("CRadioItem", module="carbonkivy.uix.radio")
register("CRadioItemLabelNeutral", module="carbonkivy.uix.radio")
...
register("CSelectionLayout", module="carbonkivy.uix.selectionlayout")
...
register("CTabHeaderIcon", module="carbonkivy.uix.tab")
register("CTabHeaderItem", module="carbonkivy.uix.tab")
register("CTabHeaderItemLayout", module="carbonkivy.uix.tab")
register("CTabHeaderPrimaryText", module="carbonkivy.uix.tab")
register("CTabHeaderSecondaryText", module="carbonkivy.uix.tab")
...
register("CTextInputLayoutBase", module="carbonkivy.uix.textinput")
register("CTextInputLayout", module="carbonkivy.uix.textinput")
register("CTextInputLayoutCircular", module="carbonkivy.uix.textinput")
...
register("CToggle", module="carbonkivy.uix.toggle")
register("CToggletip", module="carbonkivy.uix.toggletip")
register("CTooltip", module="carbonkivy.uix.tooltip")
register("ElasticScrollView", module="carbonkivy.uix.scrollview")
