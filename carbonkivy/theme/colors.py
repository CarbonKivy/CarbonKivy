...
class StaticColors:
    ...
    blue_10 = ColorProperty()
    blue_20 = ColorProperty()
    blue_30 = ColorProperty()
    blue_40 = ColorProperty()
    blue_50 = ColorProperty()
    blue_60 = ColorProperty()
    blue_70 = ColorProperty()
    blue_80 = ColorProperty()
    blue_90 = ColorProperty()
    blue_100 = ColorProperty()

    cyan_10 = ColorProperty()
    cyan_20 = ColorProperty()
    cyan_30 = ColorProperty()
    cyan_40 = ColorProperty()
    cyan_50 = ColorProperty()
    cyan_60 = ColorProperty()
    cyan_70 = ColorProperty()
    cyan_80 = ColorProperty()
    cyan_90 = ColorProperty()
    cyan_100 = ColorProperty()

    gray_10 = ColorProperty()
    gray_20 = ColorProperty()
    gray_30 = ColorProperty()
    gray_40 = ColorProperty()
    gray_50 = ColorProperty()
    gray_60 = ColorProperty()
    gray_70 = ColorProperty()
    gray_80 = ColorProperty()
    gray_90 = ColorProperty()
    gray_100 = ColorProperty()

    green_10 = ColorProperty()
    green_20 = ColorProperty()
    green_30 = ColorProperty()
    green_40 = ColorProperty()
    green_50 = ColorProperty()
    green_60 = ColorProperty()
    green_70 = ColorProperty()
    green_80 = ColorProperty()
    green_90 = ColorProperty()
    green_100 = ColorProperty()

    magenta_10 = ColorProperty()
    magenta_20 = ColorProperty()
    magenta_30 = ColorProperty()
    magenta_40 = ColorProperty()
    magenta_50 = ColorProperty()
    magenta_60 = ColorProperty()
    magenta_70 = ColorProperty()
    magenta_80 = ColorProperty()
    magenta_90 = ColorProperty()
    magenta_100 = ColorProperty()

    orange_10 = ColorProperty()
    orange_20 = ColorProperty()
    orange_30 = ColorProperty()
    orange_40 = ColorProperty()
    orange_50 = ColorProperty()
    orange_60 = ColorProperty()
    orange_70 = ColorProperty()
    orange_80 = ColorProperty()
    orange_90 = ColorProperty()
    orange_100 = ColorProperty()

    purple_10 = ColorProperty()
    purple_20 = ColorProperty()
    purple_30 = ColorProperty()
    purple_40 = ColorProperty()
    purple_50 = ColorProperty()
    purple_60 = ColorProperty()
    purple_70 = ColorProperty()
    purple_80 = ColorProperty()
    purple_90 = ColorProperty()
    purple_100 = ColorProperty()

    red_10 = ColorProperty()
    red_20 = ColorProperty()
    red_30 = ColorProperty()
    red_40 = ColorProperty()
    red_50 = ColorProperty()
    red_60 = ColorProperty()
    red_70 = ColorProperty()
    red_80 = ColorProperty()
    red_90 = ColorProperty()
    red_100 = ColorProperty()

    teal_10 = ColorProperty()
    teal_20 = ColorProperty()
    teal_30 = ColorProperty()
    teal_40 = ColorProperty()
    teal_50 = ColorProperty()
    teal_60 = ColorProperty()
    teal_70 = ColorProperty()
    teal_80 = ColorProperty()
    teal_90 = ColorProperty()
    teal_100 = ColorProperty()

    yellow_10 = ColorProperty()
    yellow_20 = ColorProperty()
    yellow_30 = ColorProperty()
    yellow_40 = ColorProperty()
    yellow_50 = ColorProperty()
    yellow_60 = ColorProperty()
    yellow_70 = ColorProperty()
    yellow_80 = ColorProperty()
    yellow_90 = ColorProperty()
    yellow_100 = ColorProperty()
